...
século \textsc{ixx}. Os mais novos aparecendo agora se mostram na maioria decididos
...
\chapterspecial{A música e a canção populares no Brasil}{1936\footnote{``Ensaio sobre a música brasileira''. \textit{Obras Completas de Mário de Andrade}, vol. \textsc{vi}. São Paulo: Livraria Martins, 1962. Transcrevemos,com ortografia atualizada, o capítulo do livro Ensaio sobre a música brasileira. Esta obra conta ainda com partituras de várias modalidades, letras de diversas canções, incluindo cantos infantis e danças.}}
