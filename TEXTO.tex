...
% \textit{Imagem 1, 2 e 3}

% \textit{(página 22 e 23 do documento original)}
...
Do parágrafo que começa com ``A bem dizer'' até este ponto, há, no
...
mar'' em vez de ``par'u mar''; ``rápida ê frria'', ``brranca''; ``ê
...
e mesmo um ``fal-la'' com dois \textit{ll}, sem a menor brasilidade.
...
surpreendente ``barítono'' sr. \textsc{h}.\,Tapajós. E com este surge um mundo
novo, que no caso é o novo mundo do Brasil. Poderemos realmente
classificar de ``barítono'' o sr. \textsc{h}.\,Tapajós? Incontestavelmente não, si
...
canta fechadamente \textit{êim} por \textit{im} na frase ``Em Mangueira também
...
Lach generaliza esses processos aos primitivos em geral''.\footnote{Mário de Andrade: Compêndio de história da música, 3ª ed. \textsc{l.g.}\,Miranda. São Paulo, 1937 (p.\,13).} Ora,
...
\textit{pai};\footnote{\textsc{j}.\,Leite de Vasconcelos: De terra em terra, Imprensa Nacional,
Lisboa, 1927 (vol.\,\textsc{i}, p.\,27).} mas, como observa o prof. Sousa da Silveira para o verbo
\textit{andar},\footnote{Sousa da Silveira: Lições de português, ed. Civilização Brasileira,
...
ressonâncias nasais foi aprovada por 42 votos contra seis.\footnote{Cf. Le Monde Musical, de outubro de 1933 (p.\,287).}
...
muito Hans Staden,\footnote{E. Roquette-Pinto: Ensaios de anthropologia brasiliana in Biblioteca Pedagógica Brasileira -- Comp. Editora Nacional, São Paulo, 1933 (p.\,97).} quase um \textsc{i}-Juca-Pirama, e um bocado também,
...
ele, essa música que o convulsionava,\footnote{\textsc{e.m.}\,Hornbostel: African Negro Music. Ed. International Institute of
...
Gostei, sim\ldots{} muitíssimo do \textit{Amélia}, é das coisas mais cariocas
...
autor de \textit{Oscarina}. Olha que eu (e você) conheço bastante os
...
século \textsc{xviii} o viajante \textsc{m}.\,Link constatava que ``as cantigas do povo
...
umbigadas ao som da cítara e viola.''.\footnote{Costa, F. Folclore pernambucano,
\textit{\textsc{rihgb}}, 1908, p.\,221.}
...
trabalha em 1928 com o ``\textit{Lundu do escravo}'', colhido em
...
no Nordeste foram por ele destinados a \textit{Na pancada do ganzá}. (V.
\textit{As melodias do boi e outras peças}, org. Oneyda Alvarenga, 1987,
p.\,131-135) Dentre estes, o intitulado \textit{Corujinha} mereceu um
...
\textit{A Semana} (Campinas) nº 16 de junho de 1894 noticiando a
...
Roca o maxixe se dançou. (V. Rossi, \textit{Cosas de negros}, 1926, p.\,179
...
linha reta da melodia italiana''. (\textit{Serenatas e saraus}, vol.\,3, p.
...
\textsc{ide}m. \textit{A Morte de João Pessoa}. Idem.
...
\textit{marchinha}. Veja capa disco nº333 (\textsc{ma})
...
V.tb.: \textit{Gaturna}, mote. (\textsc{dm-ma})
