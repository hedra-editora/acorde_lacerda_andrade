...
Andrade, vol. \textsc{vi}. São Paulo: Livraria Martins, s/d (1962).\\
...
vol. \textsc{vi}. São Paulo: Livraria Martins, s/d (1962).\\
...
(vol. \textsc{xi} das Obras Completas). O trabalho foi apresentado no Primeiro
...
\textsc{ieb-usp} -- Instituto de Estudos Brasileiros da Universidade de São
Paulo.}}{}
...
Tudo isto, si non é vero\ldots{} é, pelo menos, muito da leviandade
...
O lundu canção foi conhecido durante o primeiro Império e, no séc. \textsc{xix},
...
Discografia: Disco Victor nº33.318. Lado A -- \textsc{cardoso}, Carlos.
