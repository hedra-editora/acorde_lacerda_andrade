...
guassú com que o exotismo concorreu pro sucesso atual do artista. \textsc{h}.
...
estados fisiopsiquicos gerais de que apenas também as palavras
...
chibas, baianos, recortadas, mazurcas valsas schotis polcas{[}nota de % nota de rodapé?
...
e intituladas pelo texto que nem ``Quero Mana'',{[}nota de rodapé{]} % nota de rodapé?
...
aceitá-la pronto: vira para nós um imitador frouxo {[}nota de rodapé{]}. % nota de rodapé?
...
Lach generaliza esses processos aos primitivos em geral''.\footnote{Mário de Andrade: Compêndio de história da música, 3ª ed. \textsc{l.g.}
...
Lisboa, 1927 (v. \textsc{i}, p. 27).} mas, como observa o prof. Sousa da Silveira para o verbo
...
Macedo (Cf. ``Dois de oro'', Columbia, 22208-B) apresenta um \textit{án}
...
tumba (Victor, 33572), com ótimos nasais no \textit{a} de ``rial'' e ``naval'';
...
exigências vocais do \textit{\textit{bel canto}} europeu, sem se desnacionalizar?\ldots{}
