...
a ``Galhofeira''\footnote{Editora Bevilaqua, Rio.} de A.\,Nepomuceno.
...
garganta, a mesma \textit{malinconica}, a mesma ferócia, a mesma sexualidade
...
\textit{Sambas maxixes cocos chimarritas catiras cururus faxineiras candomblés
...
aceitá-la pronto: vira para nós um imitador frouxo. Isto se dá mesmo entre literatos, gente que por lidar com letras é
...
\textit{malinconia} tropical ; gente boa humana, gente do quarto-de-hóspede ;
...
infelicidade me persegue''\footnote{Victor, 34014.} demonstra uma hesitação \textit{quasi}
...
em ``Meus orixás'',\footnote{Victor, 33953.} ainda emitem um a nasal que
...
pinchos malabarísticos da \textit{brilhação} e da virtuosidade. Tschaikowski.
...
muito Hans Staden,\footnote{E. Roquette-Pinto, \textit{Ensaios de anthropologia brasiliana} in Biblioteca Pedagógica Brasileira -- Comp. Editora Nacional, São Paulo, 1933 (p.\,97).} quase um \textsc{i}-Juca-Pirama, e um bocado também,
...
música.\footnote{E. Dupré e M. Nathan, \textit{Le langage musical} (n.\,607). Ed.\,Felix
...
ele, essa música que o convulsionava,\footnote{E.\,M.\,Hornbostel, \textit{African Negro Music}. Ed.\,International Institute of
...
lógica nova derivava de um narrativo \textit{prosístico}, de uma Tonmalerei,
...
\textit{Folhetins} de 76, pode-se concluir que a dança e o nome nasceram dentro
